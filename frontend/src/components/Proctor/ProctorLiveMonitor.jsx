      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-slate-500">Autonomous Proctoring Engine</span>
          </div>
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-700 text-xs font-semibold text-slate-300 hover:text-white transition flex items-center space-x-1.5"
          >
        ...
        <div className="lg:col-span-6 space-y-4 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="glass-card p-5 rounded-2xl border border-slate-800">
              <span className="text-xs text-slate-400 font-medium">Session Integrity Score</span>
              <div className="text-3xl font-black text-white mt-1">{integrityScore}/100</div>
