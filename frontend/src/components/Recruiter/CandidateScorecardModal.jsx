...
export default function CandidateScorecardModal({ candidate, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-xl p-4 overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-[#0B0F19] border border-white/[0.09] rounded-3xl shadow-[0_24px_64px_-12px_rgba(0,0,0,0.85)] overflow-hidden my-6 flex flex-col max-h-[92vh] ring-1 ring-white/[0.05]">
        
        {/* Executive Candidate Hero Header */}
        <div className="p-6 bg-slate-900/70 border-b border-white/[0.08] flex flex-col sm:flex-row sm:items-center justify-between gap-4 backdrop-blur-md">
          <div className="flex items-start space-x-4">
            <div className="relative">
              ...
              <div className="absolute -bottom-1 -right-1 w-4 h-4 rounded-full bg-emerald-500 ring-2 ring-[#0B0F19]" />
            </div>
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 flex items-center space-x-2.5 flex-wrap">
                <span className="font-semibold text-slate-300">{candidate.job?.title || 'Applied Position'}</span>
                <span>•</span>
                <span>{candidate.education}</span>
                <span>•</span>
                <span>{candidate.experienceYears} Years Exp</span>
                <span>•</span>
                <span className="text-indigo-400 font-mono">{candidate.email}</span>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3 self-end sm:self-center">
            ...
            <div className="flex items-center space-x-3 bg-slate-900/80 p-2.5 px-3.5 rounded-2xl border border-white/[0.08] shadow-inner">
              <div className="relative w-11 h-11 flex items-center justify-center">
                ...
                <span className="absolute text-[11px] font-black text-emerald-400">{candidate.matchScore}%</span>
              </div>
              <div className="text-left hidden sm:block">
                <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Match Score</div>
                <div className="text-xs font-bold text-slate-200">Job Fit Calibrated</div>
              </div>
            </div>

            <button 
              onClick={onClose}
              className="p-2 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800/80 transition border border-transparent hover:border-slate-700"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        {/* Tab navigation */}
        <div className="flex border-b border-white/[0.08] bg-slate-950/60 px-6 space-x-6 text-xs font-bold overflow-x-auto">
          {[
        ...
        <div className="p-5 sm:p-6 bg-slate-900/80 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4 backdrop-blur-md">
          <div className="w-full sm:w-1/2">
            <input
              ...
              className="w-full px-3.5 py-2.5 text-xs bg-slate-950/80 border border-slate-700/80 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition"
            />
          </div>
          ...
          <div className="flex items-center space-x-2 w-full sm:w-auto justify-end flex-wrap gap-1">
            <button
              ...
              className="px-3 py-2 rounded-xl bg-rose-950/40 hover:bg-rose-900/70 text-rose-300 text-xs font-bold border border-rose-800/50 transition flex items-center space-x-1.5 shadow-sm"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-emerald-950/40 hover:bg-emerald-900/70 text-emerald-300 text-xs font-bold border border-emerald-800/50 transition flex items-center space-x-1.5 shadow-sm"
            >
