          ...
          <div className="flex items-start justify-between">
            <div className="space-y-1">
              <div className="flex items-center space-x-2">
                <span className={`w-2.5 h-2.5 rounded-full ${aiStatus.active ? 'bg-emerald-500 animate-ping' : 'bg-amber-500'}`} />
                ...
                <button
                  ...
                  className={`p-2.5 rounded-xl border text-left transition flex flex-col justify-between ${
                    selectedProvider === prov.id
                      ? 'bg-indigo-50 dark:bg-indigo-600/20 border-indigo-500 text-indigo-950 dark:text-white shadow-md shadow-indigo-600/10 ring-1 ring-indigo-500/50'
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              {selectedProvider === 'gemini' && (
                <a
                  ...
                  className="text-[11px] text-cyan-600 dark:text-cyan-400 hover:underline flex items-center space-x-1 font-semibold"
                >
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 bg-slate-50 dark:bg-[#06080E] border border-slate-300 dark:border-slate-700/80 rounded-xl text-xs sm:text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition shadow-inner font-mono pr-10"
              />
              <button
                type="button"
