  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-16">
      ...
      <div className="glass-card p-8 sm:p-10 rounded-3xl border border-slate-200 dark:border-white/[0.08] text-center space-y-5 relative overflow-hidden shadow-2xl">
        ...
        <div>
          <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider bg-emerald-500/10 px-3.5 py-1 rounded-full border border-emerald-500/25 shadow-sm">
        ...
        <div className="pt-4 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 max-w-2xl mx-auto">
          <div className="p-4 rounded-2xl bg-white/80 dark:bg-[#06080E] border border-slate-200 dark:border-white/[0.08] shadow-md">
            ...
            <div className="text-3xl font-black text-emerald-600 dark:text-emerald-400 mt-1">{cand.scores?.overall || 91}%</div>
          </div>

          <div className="p-4 rounded-2xl bg-white/80 dark:bg-[#06080E] border border-slate-200 dark:border-white/[0.08] shadow-md">
            <span className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Technical Depth</span>
            <div className="text-3xl font-black text-indigo-600 dark:text-indigo-400 mt-1">{cand.scores?.technicalScore || 94}%</div>
          </div>

          <div className="p-4 rounded-2xl bg-white/80 dark:bg-[#06080E] border border-slate-200 dark:border-white/[0.08] shadow-md">
            <span className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Communication</span>
            <div className="text-3xl font-black text-purple-600 dark:text-purple-400 mt-1">{cand.scores?.communication || 88}%</div>
          </div>

          <div className="p-4 rounded-2xl bg-white/80 dark:bg-[#06080E] border border-slate-200 dark:border-white/[0.08] shadow-md">
            <span className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Integrity Audit</span>
            <div className="text-3xl font-black text-cyan-600 dark:text-cyan-400 mt-1">{cand.integrityScore || 95}%</div>
          </div>
        </div>
      </div>
