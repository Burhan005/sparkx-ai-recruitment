...
export default function CodeAssessment() {
  ...
  const assessment = activeJob.codingAssessment || {
    title: "Real-time Telemetry Aggregator",
    language: "javascript",
    instructions: "Write a function aggregateSuspiciousEvents(events) that collapses duplicate events within 3000ms.",
    initialCode: `function aggregateSuspiciousEvents(events) {
  // Your code here
